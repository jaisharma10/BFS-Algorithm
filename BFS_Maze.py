        ...
        if currentNode.state not in obsMap:                  # if current node is not in Obstacle Space
            if currentNode.state not in visitedList:         # new state is not goal state and not in visited list
                ...
                if currentNode.state == g:  # check if goal state reached
                    ...
                    time.sleep(25) # show screen for these number of seconds
                    break
...
if __name__== "__main__":
    ...
    if s not in mapCord:
        print("Start Node is outside Map Space")
    elif g not in mapCord:
        print("Goal Node is outside Map Space")
    elif s in obsCord:
        print("Start Node is inside Obstacle Space")
    elif g in obsCord:
        print("Goal Node is inside Obstacle Space")
